...
- Just from this simple definition, can you think of a management
  situation where it would make sense to use the biological method? the
  hydrologic method? What are the advantages to each?
...
![](10-LowFLowStats-FDC_files/figure-commonmark/unnamed-chunk-6-1.png)
...
![](10-LowFLowStats-FDC_files/figure-commonmark/unnamed-chunk-7-1.png)
...
- Now you could plot that fitted, synthetic distribution as an ECDF and
  read the plot to determine, say, 10% of students (0.1 probability) are
  at or above what height?
...
![](10-LowFLowStats-FDC_files/figure-commonmark/unnamed-chunk-8-1.png)
...
![](10-LowFLowStats-FDC_files/figure-commonmark/unnamed-chunk-10-1.png)
