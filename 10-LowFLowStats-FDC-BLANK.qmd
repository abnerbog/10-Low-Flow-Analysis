...
The github repository for these notes can be found here: <https://github.com/VT-Hydroinformatics/10-Low-Flow-Analysis>
...
* The minimum value per year of those 7-day mean-daily flows
* The return intervals of those minimum yearly flows
...
Let's get started on an example. We will calculate the 7Q10 low flow statistic for the Linville NC usgs gage (USGS-02138500) using daily discharge data from 1922-1984. (parameter = 00060)
